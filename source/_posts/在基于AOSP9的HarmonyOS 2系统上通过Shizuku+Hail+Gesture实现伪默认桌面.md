...
tags:
    - HarmonyOS
    - 教程
cover: https://cf-r2-bucket-images.amaicat.work/2024/05/12/664032af86c08.webp
---
...
![Shizuku状态](https://cf-r2-bucket-images.amaicat.work/2024/05/12/663fa45b2ae05.webp)
...
应用筛选器选到 `系统` ，勾选 `华为桌面`
![Hail 华为桌面](https://cf-r2-bucket-images.amaicat.work/2024/05/12/663fa4e720530.webp)
返回首页，点击右下角冻结华为桌面
