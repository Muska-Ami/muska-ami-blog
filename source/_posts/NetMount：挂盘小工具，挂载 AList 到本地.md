...
tags:
    ...
    - AList
    - Rclone
cover: https://cf-r2-bucket-images.amaicat.work/2024/07/15/6693fe14574d8.webp
---
## 什么是 NetMount
...
![效果](https://cf-r2-bucket-images.amaicat.work/2024/07/15/6694002798d00.webp)
...
![填写内容](https://cf-r2-bucket-images.amaicat.work/2024/07/15/669401f848f2a.webp)

然后会回到 `存储` -> `管理`，点击存储旁边的 `挂载` 配置挂载。

![挂载](https://cf-r2-bucket-images.amaicat.work/2024/07/15/6694028a7239e.webp)
